...
const OnboardingStepContent = ({
	...
	return (
		<div className="flex flex-col w-full items-center gap-2">
			<p className="text-sm text-foreground/70 text-center px-2">
				Recommended: Anthropic with claude-sonnet-4-6 (1M context) for the best
				coding experience.
			</p>
...
const OnboardingView = ({
	...
	// Set default provider to Anthropic with claude-sonnet-4-6:1m on mount (once only)
	...
	useEffect(() => {
		...
		handleFieldsChange({
			...
			planModeApiModelId: "claude-sonnet-4-6:1m",
			actModeApiModelId: "claude-sonnet-4-6:1m",
		});
	}, [handleFieldsChange]);
