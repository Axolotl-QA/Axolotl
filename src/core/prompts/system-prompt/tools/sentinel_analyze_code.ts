...
const id = ClineDefaultTool.SENTINEL_ANALYZE_CODE
	...
	parameters: [
		{
			name: "file_paths",
			required: true,
			instruction: `A JSON array of file paths to analyze. These should be the files detected by sentinel_detect_changes.
...
export const sentinel_analyze_code_variants = [GENERIC]
