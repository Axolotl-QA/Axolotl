...
The user has explicitly asked you to help them create a new Cline rule file inside the .axolotl/rules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Cline rule.
...
Usage:
<new_rule>
<path>.axolotl/rules/{file name}.md</path>
<content>Cline rule file content here</content>
</new_rule>

Example:
<new_rule>
<path>.axolotl/rules/project-preferences.md</path>
<content>
## Brief overview
