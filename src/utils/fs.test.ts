...
describe("Filesystem Utilities", () => {
	...
	it("should exclude .axolotl/rules/workflows directory specifically", async () => {
		// Create a test directory structure
		const clinerulesDirTest = path.join(tmpDir, "clinerules-test")
		const clinerulesDirPath = path.join(clinerulesDirTest, ".axolotl/rules")

		// Create .axolotl/rules directory and root files
		...
		// Create .axolotl/rules/other directory and files
		...
		// Create .axolotl/rules/workflows directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".axolotl/rules", "workflows"]])
	...
	it("should exclude .axolotl/rules/hooks directory specifically", async () => {
		// Create a test directory structure
		...
		// Create .axolotl/rules/hooks directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".axolotl/rules", "hooks"]])
